...
CREATE TABLE `event_planning` (
  ...
  `OrganiserDetails` varchar(45) NOT NULL,
  `Date` date NOT NULL,
  `Time` time NOT NULL,
...
INSERT INTO `event_planning` VALUES (1,'kgomotso Party','party','kgomotso mahode','2025-10-09','09:00:00');
...
-- Dump completed on 2024-11-15 10:10:17
